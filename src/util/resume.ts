...
export const resume: Resume = {
  ...
  projects: [
    ...
    {
      name: "Snake Maze",
      link: "/snakemaze/snakemaze/index.html",
    ...
    // TODO: add more accurate dates for archives
    {
      ...
      link: "/archives/tandem/index.html",
    ...
    {
      name: "Conway's Game",
      link: "/archives/conway/index.html",
